        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8 mb-16">
          <div className="lg:col-span-2 space-y-6">
            <Link href="/" className="inline-block group">
              <Image
                alt="Mazo Sindhudurg Logo"
                width={140}
                height={48}
                className="h-10 lg:h-12 w-auto object-contain transition-transform duration-500 group-hover:scale-105 filter drop-shadow-[0_0_8px_rgba(255,255,255,0.1)]"
                src="/mazo-logo.png"
              />
            </Link>
            <p className="text-slate-400 font-body-md max-w-sm leading-relaxed">
              Your trusted companion to discovering the authentic beauty, local
              businesses, and untold stories of the Konkan coast.
            </p>
            <div className="flex items-center gap-4 pt-4">
              {/* Facebook */}
              <a
                href="#"
                className="w-11 h-11 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-slate-300 hover:bg-[#1877F2] hover:text-white hover:border-transparent hover:scale-110 hover:-translate-y-1 hover:shadow-[0_0_15px_rgba(24,119,242,0.4)] transition-all duration-300"
                aria-label="Facebook"
              >
          ...
          <div>
            ...
            <ul className="space-y-4 font-caption text-caption">
              <li>
                ...
                >
                  <ChevronRight className="w-3.5 h-3.5 opacity-0 -translate-x-3 group-hover:opacity-100 group-hover:translate-x-0 transition-all text-primary" />
          ...
          <div>
            ...
            <ul className="space-y-5 font-caption text-caption text-slate-400">
              ...
              <li className="flex items-center gap-3 group">
                ...
                <a
                  href="mailto:hello@mazosindhudurg.com"
                  className="hover:text-white transition-colors mt-1"
                >
                  hello@mazosindhudurg.com
                </a>
              </li>
              <li className="flex items-center gap-3 group">
                <div className="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center group-hover:bg-blue-500/20 group-hover:scale-110 transition-all duration-300">
