...
const BlogHeader = ({ id, onCancel, windowWidth, handleSave, isFormValid, isSaving, hasUnsavedChanges, status, isSidebarOpen, setIsSidebarOpen }: any) => {
    return (
        <div className="sticky top-4 z-50 bg-white/95 backdrop-blur-xl border border-slate-200 shadow-sm px-5 sm:px-8 py-4 rounded-3xl mb-8 flex items-center justify-between transition-all w-full">
