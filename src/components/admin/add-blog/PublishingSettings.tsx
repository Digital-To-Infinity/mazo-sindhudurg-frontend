                    ...
                    <div className="flex flex-col space-y-2">
                        ...
                        <div className="relative group">
                            ...
                            <select
                                ...
                                className="w-full bg-zinc-50/50 border border-brand-muted/50 rounded-2xl pl-12 pr-5 py-4 text-[14px] font-semibold focus:outline-none focus:border-brand-primary focus:bg-white focus:ring-4 focus:ring-brand-primary/10 transition-all appearance-none"
                            >
