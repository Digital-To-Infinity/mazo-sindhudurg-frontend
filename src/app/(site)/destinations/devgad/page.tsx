...
export const metadata: Metadata = {
  title: "Devgad Travel Guide",
  description:
    "Plan your trip to Devgad — the clearest water on the Konkan coast, backwater boat rides, scuba diving and the Karli river sangam point.",
};
...
const attractions = [
  ...
  },
  {
    ...
    tag: "Historic Fort",
    description:
      "Shivaji Maharaj\u2019s 17th-century island fort is a short boat ride from Devgad via nearby Malvan jetty, and easily combined with a beach day.",
    image:
...
const thingsToDo = [
  {
    ...
    title: "Water Sports",
    description:
      "Jet skiing, banana boat and bumper rides, and parasailing all run right off Devgad Beach through the day.",
  },
  {
    icon: Fish,
    title: "Scuba Diving & Snorkelling",
    description:
      "Devgad\u2019s unusually clear water makes it one of the few spots on this coast where beginner scuba dives are reliably good.",
  },
  {
    icon: Sailboat,
...
const faqs = [
  {
    q: "What makes Devgad different from Malvan?",
    a: "Devgad is a quieter beach village about 7 km south of Malvan town, known specifically for unusually clear water and being the region\u2019s water-sports hub. Malvan is the bigger town nearby, home to the harbour, markets and the jetty for Sindhudurg Fort.",
  },
  {
    q: "Is Devgad good for swimming?",
  ...
  {
    q: "How far is Devgad from Sindhudurg Fort?",
    a: "The fort sits just offshore near Malvan, about 7-8 km from Devgad. Most visitors drive to Malvan jetty and take the short ferry crossing from there.",
  },
  {
    q: "What is the best time to visit Devgad?",
  ...
  {
    q: "How do I get to Devgad?",
    a: "Sindhudurg (Chipi) Airport is the closest, around 30 km away. The nearest railhead is Kudal on the Konkan Railway, about 30-35 km out. By road, Devgad is just off NH66 via Malvan.",
  },
];

export default function DevgadDestinationPage() {
  return (
    <main className="font-body-md text-body-md bg-surface text-on-surface overflow-x-hidden pb-20">
      ...
      <div className="pt-20 lg:pt-24 px-margin-mobile lg:px-margin-desktop max-w-container-max mx-auto">
        ...
        >
          ...
          <ChevronRight className="w-3.5 h-3.5 text-outline-variant" />
          <span className="text-on-surface font-semibold">Devgad</span>
        </nav>
      </div>
      ...
      <section className="relative w-full mt-6 px-margin-mobile lg:px-margin-desktop max-w-container-max mx-auto">
        <div className="relative rounded-3xl overflow-hidden shadow-xl min-h-[420px] md:min-h-[520px] flex items-end">
          <Image
            ...
            alt="Clear turquoise water along the coast near Devgad"
            fill
            priority
        ...
        <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-center">
          <div>
            ...
            <div className="space-y-4 text-on-surface-variant leading-relaxed">
              <p>
                Devgad is a small village about 7 km south of Malvan, wedged
                ...
                is why Devgad grew into Sindhudurg&rsquo;s water-sports and
              ...
              <p>
                ...
                easy half-day trip, so most visitors base themselves in Devgad
          ...
          <div className="relative aspect-[4/3] rounded-3xl overflow-hidden shadow-lg">
            <Image
              ...
              alt="Palm-lined water near Devgad"
              fill
              className="object-cover"
        ...
        <div className="grid md:grid-cols-2 rounded-3xl overflow-hidden shadow-lg border border-outline-variant">
          <div className="relative min-h-[260px] md:min-h-[320px]">
            <Image
              ...
              alt="Jet ski on the water at Devgad"
              fill
              className="object-cover"
              sizes="(max-width: 768px) 100vw, 50vw"
            />
          ...
          <div className="bg-surface-container-lowest p-8 md:p-10 flex flex-col justify-center">
            ...
            <p className="text-on-surface-variant leading-relaxed mb-4">
              Licensed operators line Devgad Beach with jet skis, banana boats,
              parasailing and guided scuba dives. Rates are typically negotiated
              on the spot and vary by season &mdash; expect the widest range of
              activities and the calmest water between October and March.
            </p>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="bg-surface-container-lowest rounded-2xl border border-outline-variant p-6">
            ...
            <p className="text-sm text-on-surface-variant leading-relaxed">
              ...
              30&ndash;35 km, with buses and taxis running on to Devgad via
              Malvan.
            </p>
          </div>
          <div className="bg-surface-container-lowest rounded-2xl border border-outline-variant p-6">
            ...
            <p className="text-sm text-on-surface-variant leading-relaxed">
              Devgad sits just off NH66, about 7 km past Malvan. Expect roughly
              10&ndash;12 hours from Mumbai and about 3 hours from Goa by car or
              bus.
            </p>
          </div>
        </div>
        ...
        <div className="bg-primary rounded-3xl p-8 md:p-12 text-center relative overflow-hidden shadow-xl">
          ...
          <div className="relative z-10 max-w-2xl mx-auto space-y-6">
            ...
            <p className="text-primary-fixed font-body-lg">
              Devgad pairs perfectly with a stop in Malvan. See what else the
