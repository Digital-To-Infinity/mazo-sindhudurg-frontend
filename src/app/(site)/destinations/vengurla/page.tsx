...
export const metadata: Metadata = {
  title: "Vengurla Travel Guide",
  description:
    "Plan your trip to Vengurla — the clearest water on the Konkan coast, backwater boat rides, scuba diving and the Karli river sangam point.",
};
...
const attractions = [
  ...
  },
  {
    ...
    tag: "Historic Fort",
    description:
      "Shivaji Maharaj\u2019s 17th-century island fort is a short boat ride from Vengurla via nearby Malvan jetty, and easily combined with a beach day.",
    image:
...
const thingsToDo = [
  {
    ...
    title: "Water Sports",
    description:
      "Jet skiing, banana boat and bumper rides, and parasailing all run right off Vengurla Beach through the day.",
  },
  {
    icon: Fish,
    title: "Scuba Diving & Snorkelling",
    description:
      "Vengurla\u2019s unusually clear water makes it one of the few spots on this coast where beginner scuba dives are reliably good.",
  },
  {
    icon: Sailboat,
...
const faqs = [
  {
    q: "What makes Vengurla different from Malvan?",
    a: "Vengurla is a quieter beach village about 7 km south of Malvan town, known specifically for unusually clear water and being the region\u2019s water-sports hub. Malvan is the bigger town nearby, home to the harbour, markets and the jetty for Sindhudurg Fort.",
  },
  {
    q: "Is Vengurla good for swimming?",
  ...
  {
    q: "How far is Vengurla from Sindhudurg Fort?",
    a: "The fort sits just offshore near Malvan, about 7-8 km from Vengurla. Most visitors drive to Malvan jetty and take the short ferry crossing from there.",
  },
  {
    q: "What is the best time to visit Vengurla?",
  ...
  {
    q: "How do I get to Vengurla?",
    a: "Sindhudurg (Chipi) Airport is the closest, around 30 km away. The nearest railhead is Kudal on the Konkan Railway, about 30-35 km out. By road, Vengurla is just off NH66 via Malvan.",
  },
];

export default function VengurlaDestinationPage() {
  return (
    <main className="font-body-md text-body-md bg-surface text-on-surface overflow-x-hidden pb-20">
      ...
      <div className="pt-20 lg:pt-24 px-margin-mobile lg:px-margin-desktop max-w-container-max mx-auto">
        ...
        >
          ...
          <ChevronRight className="w-3.5 h-3.5 text-outline-variant" />
          <span className="text-on-surface font-semibold">Vengurla</span>
        </nav>
      </div>
      ...
      <section className="relative w-full mt-6 px-margin-mobile lg:px-margin-desktop max-w-container-max mx-auto">
        <div className="relative rounded-3xl overflow-hidden shadow-xl min-h-[420px] md:min-h-[520px] flex items-end">
          <Image
            ...
            alt="Clear turquoise water along the coast near Vengurla"
            fill
            priority
        ...
        <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-center">
          <div>
            ...
            <div className="space-y-4 text-on-surface-variant leading-relaxed">
              <p>
                Vengurla is a small village about 7 km south of Malvan, wedged
                ...
                is why Vengurla grew into Sindhudurg&rsquo;s water-sports and
              ...
              <p>
                ...
                easy half-day trip, so most visitors base themselves in Vengurla
          ...
          <div className="relative aspect-[4/3] rounded-3xl overflow-hidden shadow-lg">
            <Image
              ...
              alt="Palm-lined water near Vengurla"
              fill
              className="object-cover"
        ...
        <div className="grid md:grid-cols-2 rounded-3xl overflow-hidden shadow-lg border border-outline-variant">
          <div className="relative min-h-[260px] md:min-h-[320px]">
            <Image
              ...
              alt="Jet ski on the water at Vengurla"
              fill
              className="object-cover"
              sizes="(max-width: 768px) 100vw, 50vw"
            />
          ...
          <div className="bg-surface-container-lowest p-8 md:p-10 flex flex-col justify-center">
            ...
            <p className="text-on-surface-variant leading-relaxed mb-4">
              Licensed operators line Vengurla Beach with jet skis, banana
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-white/80 max-w-xl">
                ...
                across Vengurla on our hotels directory.
              </p>
            </div>
          </div>
          <Link
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="bg-surface-container-lowest rounded-2xl border border-outline-variant p-6">
            ...
            <p className="text-sm text-on-surface-variant leading-relaxed">
              ...
              30&ndash;35 km, with buses and taxis running on to Vengurla via
              Malvan.
            </p>
          </div>
          <div className="bg-surface-container-lowest rounded-2xl border border-outline-variant p-6">
            ...
            <p className="text-sm text-on-surface-variant leading-relaxed">
              Vengurla sits just off NH66, about 7 km past Malvan. Expect
        ...
        <div className="bg-primary rounded-3xl p-8 md:p-12 text-center relative overflow-hidden shadow-xl">
          ...
          <div className="relative z-10 max-w-2xl mx-auto space-y-6">
            ...
            <p className="text-primary-fixed font-body-lg">
              Vengurla pairs perfectly with a stop in Malvan. See what else the
